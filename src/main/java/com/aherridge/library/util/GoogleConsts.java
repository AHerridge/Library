...
public class GoogleConsts
{
	...
	public static final Collection<String> SCOPES = Arrays.asList("https://www.googleapis.com/auth/userinfo.email", "https://www.googleapis.com/auth/userinfo.profile", DirectoryScopes.ADMIN_DIRECTORY_USER_READONLY);
